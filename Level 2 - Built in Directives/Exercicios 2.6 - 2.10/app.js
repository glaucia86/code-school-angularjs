(function() {
  ...
  /* Controller para tratar as tab's da página */
  app.controller('StoreController', function() {
    this.products = gems;
  });

  /* Método para poder setar as Tab's na página */
  app.controller('TabController', function() {
    this.tab = 1;

    /* Método para poder apresentar a tab corrente na página */
  ...
  /* Controller para tratar as imagens das jóias na página */
  app.controller('GalleryController', function() {
    this.current = 0;

    /* Método para poder setar as imagens que estão sendo clicadas na página */
